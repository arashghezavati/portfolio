...
const Data = () => {
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Fullstack Web & Mobile Deveoper </h3>
      <p className="home__description">
        I excel at building responsive, high-quality websites and mobile apps that meet your
        needs. From personal blogs to e-commerce platforms, I bring your web
        ideas to life.
      </p>
